...
Popup {
    ...
    enter: Transition {
        NumberAnimation {
            property: "y"; from: parent.height; to: parent.height - 400; duration: 300; easing.type: Easing.OutCubic
        }
    }

    exit: Transition {
        NumberAnimation {
            property: "y"; from: parent.height - 400; to: parent.height; duration: 300; easing.type: Easing.InCubic
        }
    }
    ...
    ColumnLayout {
        ...
        Text {
            text: "¿Cuál fue el resultado de la operación?"
            font.pixelSize: 14
