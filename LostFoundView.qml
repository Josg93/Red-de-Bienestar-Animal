...
Rectangle {
    ...
    // In C++, this will come from your User Session Manager.
    // "user_123" is YOU. Any other ID is a stranger.
    property string currentUserId: "user_123"

    // -- DATA MODELS --
    ListModel {
        id: lostModel
        // Case 1: Created by ME (user_123). I can close this.
        ListElement {
            name: "Coco"; type: "Gato"; breed: "Persa"; location: "La Humboldt"; distance: "1.2 km"
            status: "lost"; date: "Hace 2 horas";
            ownerId: "user_123"; contact: "0414-555-5555"
    ...
    ColumnLayout {
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                height: 130; anchors.horizontalCenter: parent.horizontalCenter
