...
Rectangle {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            height: 110 // Slightly taller to fit title + search row comfortably
            color: Theme.backgroundColor
            z: 10
            ...
            ColumnLayout {
                ...
                // Row 1: Title
                RowLayout {
                    Image { source: "icons/dog.svg"; sourceSize: Qt.size(24, 24); Layout.preferredWidth: 24; Layout.preferredHeight: 24 }
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            spacing: 8
                            Image { source: "icons/lostIcon.svg"; height: 10; width: 10 }
                    ...
                    Rectangle {
                        ...
                        Image {
                            ...
                            width: 20
                            height: 20
                            source: "icons/filterIcon.svg"
                            anchors.centerIn: parent
                        }*/
                        Text { anchors.centerIn: parent; text: "Filtros"; font.pixelSize: 16 } // Filter Icon
                    ...
                    RowLayout {
                        spacing: 6
                        // Shortened text to fit on mobile screens
                        Text {
                            text: root.isAdminMode ? "ADMIN" : "USER"
                            font.pixelSize: 9; font.bold: true; color: root.isAdminMode ? Theme.brandPink : Theme.textGray
                        }
                        Rectangle {
                            width: 36; height: 20; radius: 10; color: root.isAdminMode ? Theme.brandPink : "#e5e7eb"
                            Rectangle { x: root.isAdminMode ? 18 : 2; y: 2; width: 16; height: 16; radius: 8; color: "white"; Behavior on x { NumberAnimation { duration: 200 } } }
                            MouseArea { anchors.fill: parent; onClicked: root.isAdminMode = !root.isAdminMode }
                        }
                    }
                }
            }
        ...
        GridView {
            ...
            clip: true
            cellWidth: width; cellHeight: 290
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Text { text: " (" + model.location + ")"; font.pixelSize: 10; color: Theme.textGray; elide: Text.ElideRight; Layout.fillWidth: true }
                        }
                        Item { Layout.fillHeight: true }
                        Button {
                            Layout.fillWidth: true; Layout.preferredHeight: 36
                            background: Rectangle { radius: 8; color: root.isAdminMode ? "#1f2937" : Theme.brandPink }
                            contentItem: Text { text: root.isAdminMode ? "✅ Aprobar" : "Ver Perfil"; color: "white"; font.bold: true; font.pixelSize: 12; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter }
                            onClicked: {
                                if (root.isAdminMode) {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Text { text: "🎉 FINALES FELICES"; font.bold: true; font.pixelSize: 11; color: Theme.textGray }
                ListView {
                    ...
                    delegate: Column {
                        ...
                        Text { text: model.name; width: 60; horizontalAlignment: Text.AlignHCenter; font.pixelSize: 10; font.bold: true; color: Theme.textDark }
                    }
                }
            }
        }
